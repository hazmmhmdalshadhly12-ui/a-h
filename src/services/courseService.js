...
export async function addCourseLesson(courseId, { title, description, video_url, video_provider, duration_minutes, order_index, is_free }) {
...
export async function updateCourseLesson(lessonId, { title, description, video_url, video_provider, duration_minutes, order_index, is_free }) {
