-- ============================================================
-- تشخيص شامل + إصلاح فوري - نسخة مصححة
-- ============================================================
...
begin
  if v_uid is null then
    ...
    if public.is_admin() then
      ...
      select p.grade into v_grade from public.profiles p where p.id = v_uid;
...
-- 5. تحقق من النتيجة
select * from public.get_student_courses('second_secondary');